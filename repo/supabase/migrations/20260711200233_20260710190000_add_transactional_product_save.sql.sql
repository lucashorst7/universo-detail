/*
# Transactional product save

Saves a product and its affiliate links in one database transaction. The RPC is
restricted to authenticated administrators and prevents the partial-update state
that could occur when product and affiliate link writes were executed separately.
*/
...
BEGIN
  ...
  IF p_product_id IS NULL THEN
    INSERT INTO public.products (
      ...
      usability, tips, image_url, rating, review_count, is_featured, is_new,
      tags, specifications
    ) VALUES (
  ...
  LOOP
    ...
    INSERT INTO public.affiliate_links (
      product_id, marketplace, url, price, is_primary, display_order
    ) VALUES (
      v_product_id,
